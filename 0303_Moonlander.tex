...
\begin{diskbox}
	\url{https://github.com/adamsralf/pygame_book/tree/main/src/02%20Examples/03%20Moonlander/v01}
\end{diskbox}
...
\begin{diskbox}
	\url{https://github.com/adamsralf/pygame_book/tree/main/src/02%20Examples/03%20Moonlander/v02}
\end{diskbox}
...
Redrawing the mountain ranges from scratch every time is certainly a huge waste of computing time. A common technique  this is to draw the image once onto a bitmap (\texttt{py\-game.sur\-face.Sur\-face}) and then simply blit this bitmap each frame. 
...
\lstsource{SRC/02 Examples/03 Moonlander/v02/moonlanderg.py}{6}{6}{python}{Moonlander (\reqref{reqEarth}.\ref{reqEarthLand}) -- importing the polygon data}{srcMoon02ga}
...
\newpage
\lstsource{SRC/02 Examples/03 Moonlander/v02/moonlanderg.py}{90}{92}{python}{Moonlander (\reqref{reqEarth}.\ref{reqEarthLand}) -- \texttt{Earth} with continents}{srcMoon02gb}
...
\lstsource{SRC/02 Examples/03 Moonlander/v02/moonlanderh.py}{9}{23}{python}{Moonlander (\reqref{reqStars}.\ref{reqStarsAnzeigen}) -- Constructor of \texttt{Sky}}{srcMoon02ha}

In \texttt{draw()}, the entries of the list are used to render the stars.

\lstsource{SRC/02 Examples/03 Moonlander/v02/moonlanderh.py}{25}{28}{python}{Moonlander (\reqref{reqStars}.\ref{reqStarsAnzeigen}) -- \texttt{Sky.draw()}}{srcMoon02hb}
...
\lstsource{SRC/02 Examples/03 Moonlander/v02/moonlanderi.py}{18}{25}{python}{Moonlander (\reqref{reqStars}.\ref{reqStarsFunkeln}) -- twinkling stars (1)}{srcMoon02ia}
...
\newpage
\lstsource{SRC/02 Examples/03 Moonlander/v02/moonlanderi.py}{27}{32}{python}{Moonlander (\reqref{reqStars}.\ref{reqStarsFunkeln}) -- twinkling stars (2)}{srcMoon02ib}
...
\lstsource{SRC/02 Examples/03 Moonlander/v02/moonlanderi.py}{147}{148}{python}{Moonlander (\reqref{reqStars}.\ref{reqStarsFunkeln}) -- twinkling stars (3) \texttt{Game.update()}}{srcMoon02ic}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{\Reqref{reqLander}: Lander}
\begin{diskbox}
	\url{https://github.com/adamsralf/pygame_book/tree/main/src/02%20Examples/03%20Moonlander/v03}
\end{diskbox}
\br{Lander}{reqLander}
\begin{enumerate}
...
\lstsource{SRC/02 Examples/03 Moonlander/v03/moonlander.py}{117}{126}{python}{Moonlander (\reqref{reqLander}.\ref{reqLanderAufbau}) -- Constructor of \texttt{Lander}}{srcMoon03a}
...
\lstsource{SRC/02 Examples/03 Moonlander/v03/moonlander.py}{128}{190}{python}{Moonlander (\reqref{reqLander}.\ref{reqLanderAufbau}) -- \texttt{Lander.create\_lander()}}{srcMoon03b}
...
\lstsource{SRC/02 Examples/03 Moonlander/v03/moonlander.py}{192}{197}{python}{Moonlander (\reqref{reqLander}.\ref{reqLanderAufbau}) -- \texttt{Lander.update()}}{srcMoon03c}
...
\lstsource{SRC/02 Examples/03 Moonlander/v03/moonlander.py}{225}{238}{python}{Moonlander (\reqref{reqLander}.\ref{reqLanderAusstoß}) -- \texttt{Game.watch\_for\_events()}}{srcMoon03d}

In \texttt{Lander.draw()}, the output switches between the two surfaces depending on the current \emph{thrust} mode.

\lstsource{SRC/02 Examples/03 Moonlander/v03/moonlander.py}{199}{203}{python}{Moonlander (\reqref{reqLander}.\ref{reqLanderAusstoß}) -- \texttt{Lander.draw()}}{srcMoon03e}
...
\begin{diskbox}
	\url{https://github.com/adamsralf/pygame_book/tree/main/src/02%20Examples/03%20Moonlander/v04}
\end{diskbox}
...
\lstsource{SRC/02 Examples/03 Moonlander/v04/moonlander.py}{127}{127}{python}{Moonlander (\reqref{reqGraviation}.\ref{reqLanderGravitation}) -- extension of the \texttt{Lander} constructor}{srcMoon04b}
...
\lstsource{SRC/02 Examples/03 Moonlander/v04/moonlander.py}{199}{200}{python}{Moonlander (\reqref{reqGraviation}.\ref{reqLanderGravitation}) -- extension of \texttt{Lander.update()}}{srcMoon04c}
...
\lstsource{SRC/02 Examples/03 Moonlander/v04/moonlander.py}{208}{212}{python}{Moonlander (\reqref{reqGraviation}.\ref{reqLanderAufsetzen}) -- \texttt{Lander.move()}}{srcMoon04d}

Finally, \texttt{Game.update()} still needs to be adapted.

\lstsource{SRC/02 Examples/03 Moonlander/v04/moonlander.py}{249}{251}{python}{Moonlander (\reqref{reqGraviation}) -- \texttt{Game.update()}}{srcMoon04e}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{\Reqref{reqGegenschub}: Counter-thrust}
\begin{diskbox}
	\url{https://github.com/adamsralf/pygame_book/tree/main/src/02%20Examples/03%20Moonlander/v05}
\end{diskbox}
...
\lstsource{SRC/02 Examples/03 Moonlander/v05/moonlander.py}{208}{214}{python}{Moonlander (\reqref{reqGegenschub}) -- adjustment of \texttt{Lander.move()}}{srcMoon05b}
...
\begin{diskbox}
	\url{https://github.com/adamsralf/pygame_book/tree/main/src/02%20Examples/03%20Moonlander/v06}
\end{diskbox}
...
\lstsource{SRC/02 Examples/03 Moonlander/v06/moonlander.py}{128}{130}{python}{Moonlander (\reqref{reqTreibstoff}) -- adjustment in the constructor of \texttt{Lander}}{srcMoon06b}
...
\lstsource{SRC/02 Examples/03 Moonlander/v06/moonlander.py}{218}{228}{python}{Moonlander (\reqref{reqTreibstoff}) -- \texttt{Lander.move()}}{srcMoon06c}
...
\lstsource{SRC/02 Examples/03 Moonlander/v06/moonlander.py}{211}{216}{python}{Moonlander (\reqref{reqTreibstoff}) -- \texttt{Lander.draw()}}{srcMoon06d}
...
\begin{diskbox}
	\url{https://github.com/adamsralf/pygame_book/tree/main/src/02%20Examples/03%20Moonlander/v07}
\end{diskbox}
...
\lstsource{SRC/02 Examples/03 Moonlander/v07/moonlander.py}{117}{131}{python}{Moonlander (\reqref{reqStatus}) -- \texttt{Lander.draw()}}{srcMoon07a}
...
\lstsource{SRC/02 Examples/03 Moonlander/v07/moonlander.py}{197}{202}{python}{Moonlander (\reqref{reqStatus}) -- \texttt{Lander.create\_status\_window()}}{srcMoon07b}
...
\lstsource{SRC/02 Examples/03 Moonlander/v07/moonlander.py}{219}{224}{python}{Moonlander (\reqref{reqStatus}) -- \texttt{Lander.draw()}}{srcMoon07c} 
...
\lstsource{SRC/02 Examples/03 Moonlander/v07/moonlander.py}{226}{247}{python}{Moonlander (\reqref{reqStatus}) -- \texttt{Lander.draw\_status()}}{srcMoon07d} 
...
\lstsource{SRC/02 Examples/03 Moonlander/v07/moonlander.py}{283}{299}{python}{Moonlander (\reqref{reqStatus}) -- \texttt{Game.watch\_for\_events()}}{srcMoon07e} 

In \texttt{restart()}, the call to the constructor is also adjusted in \zeiref{moonlander0704}.

\lstsource{SRC/02 Examples/03 Moonlander/v07/moonlander.py}{312}{317}{python}{Moonlander (\reqref{reqStatus}) -- \texttt{Game.restart()}}{srcMoon07f} 
...
\begin{diskbox}
	\url{https://github.com/adamsralf/pygame_book/tree/main/src/02%20Examples/03%20Moonlander/v08}
\end{diskbox}
...
\lstsource{SRC/02 Examples/03 Moonlander/v08/moonlander.py}{302}{312}{python}{Moonlander (\reqref{reqEnde}) -- \texttt{question}}{srcMoon08a} 
...
\lstsource{SRC/02 Examples/03 Moonlander/v08/moonlander.py}{11}{12}{python}{Moonlander (\reqref{reqEnde}) -- \texttt{MyEvents}}{srcMoon08b} 
...
\lstsource{SRC/02 Examples/03 Moonlander/v08/moonlander.py}{336}{362}{python}{Moonlander (\reqref{reqEnde}) -- \texttt{Game.watch\_for\_events()}}{srcMoon08c} 
...
\lstsource{SRC/02 Examples/03 Moonlander/v08/moonlander.py}{320}{320}{python}{Moonlander (\reqref{reqEnde}) -- \texttt{Game.landing}}{srcMoon08d} 

Finally, \texttt{restart()} is extended in \zeiref{moonlander0807} to reset the \texttt{landing} flag.

\lstsource{SRC/02 Examples/03 Moonlander/v08/moonlander.py}{378}{385}{python}{Moonlander (\reqref{reqEnde}) -- \texttt{Game.restart()}}{srcMoon08e} 


\Reqref{reqEnde}.\ref{reqEndeGewonnen} and \reqref{reqEnde}.\ref{reqEndeVerloren} are implemented in the new method \texttt{check\_land\-ing()} in \texttt{Lander}. When the lander reaches the lunar surface, its velocity is checked. If the descent speed is too high, the event \texttt{CRASHED} is triggered; otherwise, the event \texttt{LANDED} is emitted. The handling of these events itself has already been discussed above in \texttt{watch\_for\_events()} (\srcref[vref]{srcMoon08c}).

\lstsource{SRC/02 Examples/03 Moonlander/v08/moonlander.py}{293}{300}{python}{Moonlander (\reqref{reqEnde}) -- \texttt{Lander.check\_landing()}}{srcMoon08f} 

Finally, \texttt{Game.update()} must be extended to include a call to \texttt{check\_landing()}.

\lstsource{SRC/02 Examples/03 Moonlander/v08/moonlander.py}{364}{367}{python}{Moonlander (\reqref{reqEnde}) -- \texttt{Game.update()}}{srcMoon08g} 
...
\lstsource{SRC/02 Examples/03 Moonlander/v08/moonlander.py}{124}{140}{python}{Moonlander (\reqref{reqEnde}) -- \texttt{Lander.mode}}{srcMoon08h} 
...
\lstsource{SRC/02 Examples/03 Moonlander/v08/moonlander.py}{220}{232}{python}{Moonlander (\reqref{reqEnde}) -- \texttt{Lander.update()}}{srcMoon08i} 
...
\lstsource{SRC/02 Examples/03 Moonlander/v08/moonlander.py}{247}{276}{python}{Moonlander (\reqref{reqEnde}) -- \texttt{Lander.draw\_status()}}{srcMoon08j} 
...
\begin{diskbox}
	\url{https://github.com/adamsralf/pygame_book/tree/main/src/02%20Examples/03%20Moonlander/v09}
\end{diskbox}
...
\lstsource{SRC/02 Examples/03 Moonlander/v09/config.py}{14}{15}{python}{Moonlander (\reqref{reqAutopilot}) -- some constants}{srcMoon09a} 
...
\lstsource{SRC/02 Examples/03 Moonlander/v09/moonlander.py}{366}{370}{python}{Moonlander (\reqref{reqAutopilot}) -- extension of \texttt{watch\_for\_events()}}{srcMoon09b} 
