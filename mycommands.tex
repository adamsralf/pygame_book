...
% --- in die Präambel ---
% zartblau definieren (ggf. anpassen)
\definecolor{boxblue}{RGB}{232,242,255}
\definecolor{boxblueborder}{RGB}{120,165,220}

% Umgebung: breakable = Seitenumbrüche erlaubt
\newtcolorbox{diskbox}[1][]{%
	breakable,
	enhanced,
	colback=boxblue,
	colframe=boxblueborder,
	boxrule=0.6pt,
	arc=2mm,
	...
	toptitle=2mm,
	bottomtitle=1mm,
	% kleines Icon links oben
	overlay={%
		\node[anchor=north west, inner sep=2mm]
		at (frame.north west) {\large\faSave};
	},
