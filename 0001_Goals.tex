...
\begin{hintbox}[You will learn, step by step,]
\begin{itemize}
...
You can find all source code and resources on  \href{https://github.com/adamsralf/pygame_book}{\nolinkurl{github.com/adamsralf/pygame_book}} and will be updated regularly. Each section kicks off with a link to the relevant GitHub subdirectory.

\begin{warningbox}[What is \emph{not} part of this script:]
\begin{itemize}
...
When writing this book, I felt a bit out of practice with my English. To make the text more readable, I used ChatGPT to translate my original German manuscript. Nevertheless, all content, ideas, explanations, and source code are not AI-generated. 
