...
class EndlessBackground(pygame.sprite.Sprite):
    ...
    def update(self, *args: Any, **kwargs: Any) -> None:
        ...
        if "action" in kwargs.keys():
            if kwargs["action"] == "toggle_frame":
                ...
                self.scroll()
                pos_tile1 = cfg.world2camera(self.bgimage.rect, self.offset)
                pos_tile1.left = pos_tile1.left % self.bgimage.rect.width   
                pos_tile1.top = pos_tile1.top % self.bgimage.rect.height    # §\label{srcEndless0301}§
                self.image.fill("Grey")
                self.image.blit(self.bgimage.image, pos_tile1)
                if pos_tile1.left > 0:                                      
                    pos_tile2 = pos_tile1.copy()
                    pos_tile2.right = pos_tile1.left
                    self.image.blit(self.bgimage.image, pos_tile2)
                if pos_tile1.left < 0:                                    
                    pos_tile2 = pos_tile1.copy()
                    pos_tile2.left = pos_tile1.right
                    self.image.blit(self.bgimage.image, pos_tile2)
                if pos_tile1.top > 0:                                       # §\label{srcEndless0302}§
                    pos_tile2 = pos_tile1.copy()
                    pos_tile2.bottom = pos_tile1.top
                    self.image.blit(self.bgimage.image, pos_tile2)
                if pos_tile1.bottom < self.image.get_height():            # §\label{srcEndless0303}§
                    pos_tile2 = pos_tile1.copy()
                    pos_tile2.top = pos_tile1.bottom
                    self.image.blit(self.bgimage.image, pos_tile2)
                if pos_tile1.left > 0 and pos_tile1.top > 0:
                    pos_tile3 = pos_tile1.copy()
                    pos_tile3.right = pos_tile1.left
                    pos_tile3.bottom = pos_tile1.top
                    self.image.blit(self.bgimage.image, pos_tile3)
                if pos_tile1.right < self.image.get_width() and pos_tile1.top > 0:
                    pos_tile3 = pos_tile1.copy()
                    pos_tile3.left = pos_tile1.right
                    pos_tile3.bottom = pos_tile1.top
                    self.image.blit(self.bgimage.image, pos_tile3)
                # Unten-Links
                if pos_tile1.left > 0 and pos_tile1.bottom < self.image.get_height():
                    pos_tile3 = pos_tile1.copy()
                    pos_tile3.right = pos_tile1.left
                    pos_tile3.top = pos_tile1.bottom
                    self.image.blit(self.bgimage.image, pos_tile3)
                # Unten-Rechts
                if pos_tile1.right < self.image.get_width() and pos_tile1.bottom < self.image.get_height():
                    pos_tile3 = pos_tile1.copy()
                    pos_tile3.left = pos_tile1.right
                    pos_tile3.top = pos_tile1.bottom
                    self.image.blit(self.bgimage.image, pos_tile3)
    ...
    def scroll(self) -> None:
        if self.player:
            ...
            self.offset.y = self.player.rect.centery - self.rect.height / 2 # §\label{srcEndless0304}§
...
class Player(pygame.sprite.Sprite):
    def __init__(self) -> None:
        ...
        self.images = {
            ...
            "top": pygame.Surface((width, width), pygame.SRCALPHA),         # §\label{srcEndless0305}§
        ...
        pygame.draw.polygon(self.images["top"], "Red", [(w4, w2), (w2, 0), (w - w4, w2)]) # §\label{srcEndless0306}§
        self.images["bottom"].blit(self.images["stop"], (0, 0))
        pygame.draw.polygon(self.images["bottom"], "Red", [(w4, w2), (w2, w), (w - w4, w2)])
    ...
    def update(self, *args: any, **kwargs: any) -> None:
        ...
        if "move" in kwargs.keys():
            if kwargs["move"] == "left":
                ...
                self.speed.x = 200
            elif kwargs["move"] == "top":                                  # §\label{srcEndless0307}§
                self.speed.y = -200
    ...
    def watch_for_events(self) -> None:
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                elif event.key == pygame.K_UP:              # §\label{srcEndless0308}§
