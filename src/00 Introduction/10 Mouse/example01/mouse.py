...
class Game:
    ...
    def __init__(self) -> None:
        pygame.init()
        self.window = pygame.Window(size=Game.WINDOW.size, title="Dealing with mouse events")
    ...
    def update(self):
        ...
        if Game.INNER_RECT.collidepoint(pygame.mouse.get_pos()):  # Hide cursor?§\label{srcMaus0003}§
