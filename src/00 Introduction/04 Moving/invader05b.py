...
def main():
    ...
    defender_speed = 2          # §\label{srcInvader0505}§
    defender_direction_h = +1   # §\label{srcInvader0506}§
    ...
    while running:
        ...
        # Update
        defender_rect.left += defender_direction_h * defender_speed  # more flexible§\label{srcInvader0507}§
