...
class Sun:
    def __init__(self, window: pygame.window.Window, horizon: int) -> None:
        self.speed = 1
        self.radius = 40
        self.pos = [-self.radius, 0]                # §\label{srcLandscape0601}§
...
def main():
    ...
    sun = Sun(window, horizon)                      # §\label{srcLandscape0602}§                   
    ...
    while running:
        ...
        # Updates
        sun.update()                                # §\label{srcLandscape0603}§

        # Draw 
        sky.draw()
        sun.draw()                                  # §\label{srcLandscape0604}§
        meadow.draw()                               
        tree.draw()
        house.draw()
        window.flip()       
