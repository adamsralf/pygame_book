...
class Lander:
    def __init__(self, screen: pygame.surface.Surface) -> None:
        ...
        self.rect.centerx = cfg.WINDOW.centerx      # horizontal start position§\label{moonlander0304}§
        self.rect.top = self.rect.height            # vertical start position§\label{moonlander0305}§
        self.create_lander()                        # Drawing is delegated§\label{moonlander0301}§
        self.thrusting = False                      # Flag whether acceleration is active§\label{moonlander0302}§
    ...
    def create_lander(self) -> None:
        ...
        # Thruster exhaust§\label{moonlander0303}§
