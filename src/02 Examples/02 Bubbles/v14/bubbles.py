...
class Game:
    ...
    def __init__(self) -> None:
        ...
        Game.SOUND_CONTAINER["bubble"] = pygame.mixer.Sound(cfg.get_sound("plopp1.mp3"))  # §\label{srcBubble1302}§
        Game.SOUND_CONTAINER["burst"] = pygame.mixer.Sound(cfg.get_sound("burst.mp3"))
        Game.SOUND_CONTAINER["clash"] = pygame.mixer.Sound(cfg.get_sound("glas.wav"))
        ...
        self.wait_start_time = None  # Zeitstempel für die Wartezeit
        self.wait_duration = 5000  # 5 Sekunden in Millisekunden
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_ESCAPE:
                    ...
                    if self.state in [GameState.GAME_OVER, GameState.WAITING]:
                        self.restart()
    ...
    def check_waiting_timeout(self) -> None:
        if self.wait_start_time is not None:
            elapsed_time = pygame.time.get_ticks() - self.wait_start_time
