...
Hint: It is a waste of computing time to render the text every frame. Try to cache the rendered \texttt{Surface}-Object and use some kind of dirty-flag to indicate, if the text was updated.
...
\myebild{font03}{1.0}{Example of using a locally installed font}{picFont02}
...
In \abbref[vref]{picFont02} you can admire the result ;-)
...
\lstsource{SRC/00 Introduction/07 Fonts/textbitmaps/textbitmaps.py}{7}{19}{python}{Textbitmaps (2), \texttt{Spritelib}}{srcTextbitmaps00b} 
...
\lstsource{SRC/00 Introduction/07 Fonts/textbitmaps/textbitmaps.py}{22}{28}{python}{Textbitmaps (3): Constructor of \texttt{Letters}}{srcTextbitmaps00c} 
...
\lstsource{SRC/00 Introduction/07 Fonts/textbitmaps/textbitmaps.py}{88}{101}{python}{Textbitmaps (5): \texttt{get\_letter()} and \texttt{get\_text()} von \texttt{Letters}}{srcTextbitmaps00e} 
...
\lstsource{SRC/00 Introduction/07 Fonts/textbitmaps/textbitmaps.py}{104}{140}{python}{Textbitmaps (6): \texttt{TextBitmaps}}{srcTextbitmaps00f}

\myebild{textbitmaps00}{0.7}{Text output using bitmaps}{picTextbitmaps01}
