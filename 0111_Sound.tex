...
\lstsource{SRC/00 Introduction/11 Sound/music/sound.py}{8}{22}{python}{Sound -- Constructor and \texttt{sounds()} of \texttt{Game}}{srcSound00b} 
...
\lstsource{SRC/00 Introduction/11 Sound/music/sound.py}{24}{42}{python}{Sound -- \texttt{Game.watch\_for\_events()}}{srcSound00c} 
...
\lstsource{SRC/00 Introduction/11 Sound/music/sound.py}{45}{49}{python}{Sound -- \texttt{Game.music\_start\_stop()}}{srcSound00e} 
...
\lstsource{SRC/00 Introduction/11 Sound/music/sound.py}{51}{56}{python}{Sound -- \texttt{Game.pause\_alter()}}{srcSound00f} 
...
\lstsource{SRC/00 Introduction/11 Sound/music/sound.py}{58}{62}{python}{Sound -- \texttt{volume\_alter()} von \texttt{Game}}{srcSound00g} 

And finally, we deal with the remaining bits.

\lstsource{SRC/00 Introduction/11 Sound/music/sound.py}{64}{84}{python}{Sound -- \texttt{draw()}, \texttt{update()}, \texttt{run()} of \texttt{Game}}{srcSound00h} 
...
\lstsource{SRC/00 Introduction/11 Sound/effects/sound.py}{17}{19}{python}{Sound -- \texttt{Game.sound()}}{srcSound01a} 
...
\newpage
\lstsource{SRC/00 Introduction/11 Sound/effects/sound.py}{38}{43}{python}{Sound -- \texttt{Game.volume\_alter()}}{srcSound01b} 
...
\lstsource{SRC/00 Introduction/11 Sound/effects/sound.py}{21}{36}{python}{Sound -- \texttt{Game.watch\_for\_events()()}}{srcSound01c} 
...
\lstsource{SRC/00 Introduction/11 Sound/stereo/sound.py}{11}{22}{python}{Sound-Stereo -- Class \texttt{Ground}}{srcSound01ab} 
...
\newpage
\lstsource{SRC/00 Introduction/11 Sound/stereo/sound.py}{25}{49}{python}{Sound-Stereo -- Constructor of \texttt{Tank}}{srcSound02b} 

The \texttt{update()} method is shown here only for completeness. It does not contain any code related to sound playback.

\lstsource{SRC/00 Introduction/11 Sound/stereo/sound.py}{51}{74}{python}{Sound-Stereo -- \texttt{Tank.update()}}{srcSound02c} 
...
\end{hintbox}
 ...
 \lstsource{SRC/00 Introduction/11 Sound/stereo/sound.py}{76}{79}{python}{Sound-Stereo -- \texttt{Tank.stereo()}}{srcSound02d} 
...
\lstsource{SRC/00 Introduction/11 Sound/stereo/sound.py}{81}{88}{python}{Sound-Stereo -- \texttt{Tank.turn()} and \texttt{Tank.update\_imageindex()}}{srcSound02e} 
...
\lstsource{SRC/00 Introduction/11 Sound/stereo/sound.py}{91}{125}{python}{Sound-Stereo -- Class \texttt{Bullet}}{srcSound02g} 

The remaining source code is shown here only for the sake of completeness.

\lstsource{SRC/00 Introduction/11 Sound/stereo/sound.py}{128}{185}{python}{Sound-Stereo -- Rest}{srcSound02h} 
