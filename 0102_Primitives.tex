...
rectangle. There are several ways to define a rectangle in Pygame. Since we will need it very often later on, I~would like to introduce the class \texttt{pygame.rect.Rect}\myindex{pyg}{\texttt{rect}!\texttt{Rect}}\randnotiz{Rect} here. It is defined by four parameters: the upper-left corner, its width, and its height. In \zeiref{srcPrimitives02}, a rectangle is therefore defined at the position $(10,10)$ with a width of \SI{20}{px} and a height of \SI{30}{px}.
