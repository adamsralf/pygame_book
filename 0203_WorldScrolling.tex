...
A first naive approach would be to scale down the world using \texttt{transform.scale\_by()}\myindex{pyg}{\texttt{transform}!\texttt{scale\_by()}} (see \zeiref{windowsv0301}). This approach has the following advantages and disadvantages:
...
\lstsource{SRC/01 Techniques/03 WorldScrolling/V08/camera_demo.py}{68}{84}{python}{Big World -- \texttt{Game.draw()}}{srcCamerademo09}
