...
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Time-based Actions}\index{Time-based}\label{secZeitsteuerung}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Introduction}
\begin{diskbox}
	\begin{itemize}
		\item \url{https://github.com/adamsralf/pygame_book/tree/main/src/00%20Introduction/09%20Time/v01}
		\item \url{https://github.com/adamsralf/pygame_book/tree/main/src/00%20Introduction/09%20Time/v02}
		\item \url{https://github.com/adamsralf/pygame_book/tree/main/src/00%20Introduction/09%20Time/v03}
	\end{itemize}
\end{diskbox}
...
\lstsource{SRC/00 Introduction/09 Time/v01/time.py}{8}{23}{python}{Time-based actions (2), Version 1.0 -- \texttt{Enemy}}{srcTime00b} 
...
\newpage
\lstsource{SRC/00 Introduction/09 Time/v01/time.py}{26}{39}{python}{Time-based actions (3), Version 1.0 -- \texttt{Bullet}}{srcTime00c} 
...
\lstsource{SRC/00 Introduction/09 Time/v01/time.py}{42}{65}{python}{Time-based actions (4), Version 1.0 -- Constructor and \texttt{run()} of \texttt{Game}}{srcTime00d} 

The methods \texttt{watch\_for\_events()} and \texttt{draw()} also do not contain anything special.

\lstsource{SRC/00 Introduction/09 Time/v01/time.py}{67}{79}{python}{Time-based actions (5), Version 1.0 --  \texttt{watch\_for\_events()} and \texttt{draw()} of \texttt{Game}}{srcTime00e} 
...
\lstsource{SRC/00 Introduction/09 Time/v01/time.py}{87}{87}{python}{Time-based actions (6), Version 1.0 -- \texttt{update()} and \texttt{new\_bullet()} of \texttt{Game}}{srcTime00f} 
...
\begin{hintbox}[Time-based counter]
...
\lstsource{SRC/00 Introduction/09 Time/v02/time.py}{51}{54}{python}{Time-based actions (7), Version 1.1 -- Constructor of \texttt{Game}}{srcTime01a} 
...
\lstsource{SRC/00 Introduction/09 Time/v02/time.py}{88}{92}{python}{Time-based actions (8), Version 1.1 -- \texttt{new\_bullet()} of \texttt{Game}}{srcTime01b} 
...
\newpage
\lstsource{SRC/00 Introduction/09 Time/v03/time.py}{50}{54}{python}{Time-based actions (9), Version 1.2 -- Constructor of \texttt{Game}}{srcTime02a} 
...
\lstsource{SRC/00 Introduction/09 Time/v03/time.py}{88}{91}{python}{Time-based actions (10), Version 1.2 -- \texttt{new\_bullet()} of \texttt{Game}}{srcTime02b} 
...
\begin{hintbox}[Hint]
	Time control using events is introduced in \secref[vref]{eventtime}.
\end{hintbox}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{The Class Timer}\label{secClassTimer}\index{time!class Timer}
\begin{diskbox}
	\url{https://github.com/adamsralf/pygame_book/tree/main/src/00%20Introduction/09%20Time/v04}
\end{diskbox}
...
\lstsource{SRC/00 Introduction/09 Time/v04/time.py}{8}{21}{python}{Time-based actions (11), Version 1.3 -- Class \texttt{Timer}}{srcTime03a} 
...
\lstsource{SRC/00 Introduction/09 Time/v04/time.py}{67}{69}{python}{Time-based actions (12), Version 1.3 -- creating a \texttt{Timer} object}{srcTime03b} 
...
\lstsource{SRC/00 Introduction/09 Time/v04/time.py}{103}{105}{python}{Time-based actions (13), Version 1.3 -- Using a \texttt{Timer} object verwenden}{srcTime03c} 
