...
\lstsource{SRC/00 Introduction/09 Time/v01/time.py}{81}{87}{python}{Time-based actions (6), Version 1.0 -- \texttt{update()} and \texttt{new\_bullet()} of \texttt{Game}}{srcTime00f} 
